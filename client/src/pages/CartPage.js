...
const stripePromise = loadStripe("pk_test_51LNwMzGImNHGHVteKpDeZe3RwIJpa1ASdveNe7qiUtMph4j2dOazyxkQDopTU4RW0oPNY3BIPSWKv2Tbs073iquY00yJqu20p7")
  ...
  return (
    <Container style = {{minHeight: '95vh'}} className="cart-container">
        <Row>
            ...
            {cart.length === 0? (
                <Alert varient='info'>Shopping cart is empty. Add products to cart.</Alert>
            ) : (
